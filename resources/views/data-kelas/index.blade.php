                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('kelas.store') }}" id="createKelas" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        <label for="lecture_number_create">Dosen Pengampu</label>
                                                        <input type="text"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            onclick="document.getElementById('createKelas').submit();">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
